...
If you want to reference my full `index.js` file, click [HERE](https://github.com/thamdanh/braydoncoyer/blob/main/index.js).
...
Thanks for reading! If you liked this article and want more content like this, read some of my other blog posts and make sure to follow me on [Twitter](https://twitter.com/TillyCoyer)!