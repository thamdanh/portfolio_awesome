...
Check out my starter template [HERE!](https://github.com/thamdanh/tailwindcss-v2-dark-mode-template)
...
You can clone the repo [HERE!](https://github.com/thamdanh/tailwindcss-v2-dark-mode-template)
