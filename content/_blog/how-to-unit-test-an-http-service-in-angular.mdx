...
If you'd like to follow along, feel free to clone down [this repo](https://github.com/thamdanh/angular-service-test-http) before continuing! I've created a `starting` branch that has everything you need to follow along!
...
Feel free to check the `completed_tests` branch of my [GitHub repository](https://github.com/thamdanh/angular-service-test-http/tree/completed_tests) and use it as a reference if you get stuck!
