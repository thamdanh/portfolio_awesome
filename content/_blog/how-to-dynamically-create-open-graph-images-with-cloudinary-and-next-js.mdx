...
Read on to learn how to do this, or check out my [open source blogfolio on GitHub](https://github.com/thamdanh/braydoncoyer.dev) and see how I accomplished this.
...
export function Container(props) {
  const { children, ...customMeta } = props;
    ...
    type: 'article'
    twitterHandle: "https://twitter.com/TillyCoyer",
  ...
  return (
    <div className={`bg-white dark:bg-dark min-h-screen`}>
	    <Head>
            ...
            <meta property="og:site_name" content="Tilly Danh" />
...
If you've made it this far and completed this article, I'd love for you to reach out to me on [Twitter](https://twitter.com/TillyCoyer) and send me a link to your blog or website so I can see the Open Graph images at work!
