...
export function ProfilePicture() {
  const [imageSrc, setImageSrc] = useState("/tillydanh_headshot_1.png");
  const [isChanging, setIsChanging] = useState(false);

  const changeImage = () => {
    setIsChanging(true);
    const images = [
      "/tillydanh_headshot_1.png",
      "/tillydanh_headshot_3.png",
      "/tillydanh_headshot_2.png",
      "/tillydanh_headshot_5.png",
    ];
